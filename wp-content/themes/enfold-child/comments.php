...
<div class='comment_meta_container'>
			...
			<div class='side-container-comment'>
	        		...
	        		<div class='side-container-comment-inner'>
	        			...
	        			<span class='comment-count'><?php echo $ccount . '<strong>COMMENTS</strong>' ?></span>
...
/* Last but not least the comment_form() wordpress function
	 ...
	 */
	 if(comments_open()){
		 ...
		 echo "<div class='comment_container comment_container-main'>";
...
if ( have_comments() ) : ?>
			...
			<div class='comment_container 222'>
