...
$string_tmp= "col-md-12";
} else{
$string_tmp= "col-md-6";

}
	$defaults = array(
		'comment_field'        => '<p class="comment-form-comment ' . $string_tmp . '"> <textarea id="comment" name="comment" cols="45" rows="8" placeholder="Comment *" maxlength="65525" aria-required="true" required="required"></textarea></p>',
		'fields'               => $fields,
